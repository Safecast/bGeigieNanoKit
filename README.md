...
# Acknowledgements
This work would not exist without the original development by [bidouilles] (https://github.com/bidouilles/bGeigieNano) and other from additional [safecast] (https://github.com/Safecast/bGeigieNano) developers.
